...
<body
				...
				<tr style="width: 100%; height: 90px">
					...
					<td>
						...
						if (tt == 1) {
							...
							+ "&vitri=baivietduyet'><span style='background-color: green;border: solid thin;color:white;padding: 2px;box-shadow: 1px 1px 1px gray'>Đã duyệt</span></a>");
						} else {
							int id = bv.get(i).getId_baiviet();
							out.write("<a style='text-decoration: none' href='baiviet_duyet?id=" + id
							+ "&vitri=baivietkhoa'><span style='background-color: #B40404;border: solid thin;color:white;padding: 2px;box-shadow: 1px 1px 1px gray'>Chưa duyệt</span></a>");
						}
						%>
					</td>
	...
	<div class="w3-center">
		...
		<i class="fad fa-exclamation-circle fa-5x"
			style="margin: -5px 0% 0 15%; float: left; color: #FF8000"></i>
		<div style="font-size: 26pt; margin: 120px 8% 0 0%; color: #FF8000">Không
			tìm thấy bài viết <%=trangthai %></div>
		<%
		}
		%>
	</div>
