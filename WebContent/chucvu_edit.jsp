...
<body style="background-image: url('images/hethong/background.png');">
	<form action="chucvu_edit" method="post">
		<table style="margin: 100px auto;width: 30%;height: 200px">
			<tr><td colspan="2" style="text-align: center;font-size: 20pt;color:red;font-weight: bold;">Sửa Chức Vụ</td></tr>
			<tr>
				<td colspan="2"><input type="text" name="txtid_chucvu" value="<%=cv.get(0).getId_chucvu() %>" hidden></td>
			</tr>
			<tr>
				<td><b>- Tên chủ đề</b></td>
				<td style="width: 60%"><input type="text" style="width: 100%;height: 30px" name="txtchucvu" value="<%=cv.get(0).getChucvu() %>"></td>
			</tr>
			<tr>
